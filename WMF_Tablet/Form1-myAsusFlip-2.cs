...
namespace WMF_Tablet
{
    ...
    public partial class frmLogin : Form
    {
        ...
        int CommpanyIndex=0;//1=合澤(03)、2=合永(10)
        ...
        {
            //CommpanyIndex = 0;//1=合澤(03)、2=合永(10)
            if (CommpanyIndex == 1)
            {
                if(cnn!=null && cnn.State==ConnectionState.Open) cnn.Close();
                cnn = new SqlConnection("Data Source=localhost;Database=FC_IdeaHouseDB;Integrated Security=false;User ID=sa;Password=1234;TrustServerCertificate=true;");
            ...
            {
                if (cnn != null && cnn.State == ConnectionState.Open) cnn.Close();
                cnn = new SqlConnection("Data Source=localhost;Database=FC_IdeaHouseDB03;Integrated Security=false;User ID=sa;Password=1234;TrustServerCertificate=true;");
