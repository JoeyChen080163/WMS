...
namespace WMF_Tablet
{
    ...
    public partial class frmLogin : Form
    {
        ...
        public static Company company=Company.eNone;
        ...
        public static string myPW = "2jdiojxl";
        ...
        public frmLogin()
        {
            ...
            mstrConn1 = $"Data Source=localhost;Database=FC_IdeaHouseDB;Integrated Security=false;User ID=sa;Password=2jdiojxl;TrustServerCertificate=true;";
            mstrConn2 = $"Data Source=localhost;Database=FC_IdeaHouseDB3;Integrated Security=false;User ID=sa;Password=2jdiojxl;TrustServerCertificate=true;";
            mstrConn3 = $"Data Source=localhost;Database=FC_IdeaHouseDB6;Integrated Security=false;User ID=sa;Password=2jdiojxl;TrustServerCertificate=true;";
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            */
            ...
            {
                string mstrLine;
                while ((mstrLine = sr.ReadLine()) != null)
                {
                    ListLine.Add(mstrLine);
                }
            }

            string aaa = ListLine[1];
            if (ListLine[1]== "合澤(03)")
            {
                //int CommpanyIndex = 0;//1=合澤(03)、2=合永(10),3=小澤(06)
                CommpanyIndex = 1;
                company = Company.e合澤03;
            }
            else if(ListLine[1]== "合永(10)")
            {
                CommpanyIndex = 2;
                company = Company.e合永10;
            }
            else if(ListLine[1] == "小澤(06)")
            {
                CommpanyIndex = 3;
                company = Company.e小澤06;
            }
        }
