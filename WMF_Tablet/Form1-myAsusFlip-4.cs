...
namespace WMF_Tablet
{
    ...
    public partial class frmLogin : Form
    {
        ...
        SqlCommand cmd;
        SqlDataReader dr;
        string mstrConn1 = "Data Source=localhost;Database=FC_IdeaHouseDB;Integrated Security=false;User ID=sa;Password=1234;TrustServerCertificate=true;";
        string mstrConn2 = "Data Source=localhost;Database=FC_IdeaHouseDB03;Integrated Security=false;User ID=sa;Password=1234;TrustServerCertificate=true;";
        string mstrConn3 = "Data Source=localhost;Database=FC_IdeaHouseDB06;Integrated Security=false;User ID=sa;Password=1234;TrustServerCertificate=true;";
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            if (CommpanyIndex == 1)
            {
                ...
                if(dr1.HasRows)
                {
                    ...
                    SqlCommand cmdPda = new SqlCommand("SELECT * FROM PDAInfo WHERE 1=1 AND IMEI='"+mGetDeviceData.CpuID+"'");
