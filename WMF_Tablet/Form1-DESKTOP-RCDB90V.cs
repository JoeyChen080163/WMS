...
namespace WMF_Tablet
{
    ...
    public partial class frmLogin : Form
    {
        ...
        {
            InitializeComponent();
            mstrConn1 = $"Data Source={myip};Database=FC_IdeaHouseDB;Integrated Security=false;User ID={myID};Password={myPW};TrustServerCertificate=true;";
            mstrConn2 = $"Data Source={myip};Database=FC_IdeaHouseDB03;Integrated Security=false;User ID={myID};Password={myPW};TrustServerCertificate=true;";
